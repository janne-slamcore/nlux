...
import { InferenceConfiguration, BedrockRuntimeClientConfigType } from '@aws-sdk/client-bedrock-runtime';
...
interface ChatAdapterBuilder<AiMsg> extends ChatAdapterBuilder$1<AiMsg> {
     ...
     */
    withCredintial(cred: BedrockRuntimeClientConfigType['credentials']): ChatAdapterBuilder<AiMsg>;
    /**
     ...
     * @returns {ChatAdapterBuilder}
     */
    withInferenceConfig(inferenceConfig: InferenceConfiguration): ChatAdapterBuilder<AiMsg>;
    /**
...
export type { ChatAdapterBuilder, ChatAdapterOptions };
