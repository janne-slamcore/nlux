(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('http2'), require('stream'), require('url'), require('buffer'), require('http'), require('fs/promises'), require('fs'), require('crypto'), require('path'), require('child_process'), require('util'), require('os'), require('https'), require('process')) :
    typeof define === 'function' && define.amd ? define(['exports', 'http2', 'stream', 'url', 'buffer', 'http', 'fs/promises', 'fs', 'crypto', 'path', 'child_process', 'util', 'os', 'https', 'process'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["@nlux/bedrock"] = {}, global.http2, global.stream, global.url, global.buffer, global.http, global.fs$1, global.fs, global.crypto$1, global.path, global.child_process, global.util, global.os, global.https, global.process$1));
})(this, (function (exports, http2, stream, url, buffer, http, fs$1, fs, crypto$1, path, child_process, util, os, https, process$1) { 'use strict';
...
`);
    ...
    const _data$3 = { parameters: { Region: h$3, UseDualStack: i$3, UseFIPS: i$3, Endpoint: h$3 }, rules: [{ conditions: [{ [t$3]: b$3, [u$3]: [j$3] }], rules: [{ conditions: p$3, error: "Invalid Configuration: FIPS and custom endpoint are not supported", type: d$3 }, { rules: [{ conditions: q$3, error: "Invalid Configuration: Dualstack and custom endpoint are not supported", type: d$3 }, { endpoint: { url: j$3, properties: m$3, headers: m$3 }, type: e$3 }], type: f$3 }], type: f$3 }, { rules: [{ conditions: [{ [t$3]: b$3, [u$3]: r$3 }], rules: [{ conditions: [{ [t$3]: "aws.partition", [u$3]: r$3, assign: g$3 }], rules: [{ conditions: [k$3, l$3], rules: [{ conditions: [{ [t$3]: c$3, [u$3]: [a$3, n$3] }, o$3], rules: [{ rules: [{ endpoint: { url: "https://bedrock-runtime-fips.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: m$3, headers: m$3 }, type: e$3 }], type: f$3 }], type: f$3 }, { error: "FIPS and DualStack are enabled, but this partition does not support one or both", type: d$3 }], type: f$3 }, { conditions: p$3, rules: [{ conditions: [{ [t$3]: c$3, [u$3]: [n$3, a$3] }], rules: [{ rules: [{ endpoint: { url: "https://bedrock-runtime-fips.{Region}.{PartitionResult#dnsSuffix}", properties: m$3, headers: m$3 }, type: e$3 }], type: f$3 }], type: f$3 }, { error: "FIPS is enabled but this partition does not support FIPS", type: d$3 }], type: f$3 }, { conditions: q$3, rules: [{ conditions: [o$3], rules: [{ rules: [{ endpoint: { url: "https://bedrock-runtime.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: m$3, headers: m$3 }, type: e$3 }], type: f$3 }], type: f$3 }, { error: "DualStack is enabled but this partition does not support DualStack", type: d$3 }], type: f$3 }, { rules: [{ endpoint: { url: "https://bedrock-runtime.{Region}.{PartitionResult#dnsSuffix}", properties: m$3, headers: m$3 }, type: e$3 }], type: f$3 }], type: f$3 }], type: f$3 }, { error: "Invalid Configuration: Missing Region", type: d$3 }], type: f$3 }] };
    ...
    let AccessDeniedException$1 = class AccessDeniedException extends BedrockRuntimeServiceException {
    ...
    let InternalServerException$1 = class InternalServerException extends BedrockRuntimeServiceException {
    ...
    let ResourceNotFoundException$1 = class ResourceNotFoundException extends BedrockRuntimeServiceException {
    ...
    const throwDefaultError$3 = withBaseException(BedrockRuntimeServiceException);
    ...
    const de_InternalServerException_event = async (output, context) => {
        ...
        return de_InternalServerExceptionRes$1(parsedOutput);
    };
    ...
    const de_GuardrailAutomatedReasoningFindingList = (output, context) => {
        const retVal = (output || [])
            .filter((e) => e != null)
            .map((entry) => {
            return de_GuardrailAutomatedReasoningFinding(awsExpectUnion(entry));
        });
        return retVal;
    };
    ...
    const _BedrockChatAdapterImpl = class _BedrockChatAdapterImpl {
      constructor(options) {
        ...
        if (!options.model || !options.credentials || !options.region) {
          throw new NluxValidationError({
            ...
            message: "when creating the Bedrock adapter, you must set model, credentials and region"
          });
        }
      ...
      get dataTransferMode() {
        return this.options.dataTransferMode ?? _BedrockChatAdapterImpl.defaultDataTransferMode;
      }
      get id() {
      ...
      async batchText(message) {
        ...
        try {
          ...
          const message2 = error.message || "An error occurred while sending the message to the Bedrock API";
          throw new NluxError({
            source: this.constructor.name,
            message: message2,
    ...
    __publicField$1(_BedrockChatAdapterImpl, "defaultDataTransferMode", "batch");
    let BedrockChatAdapterImpl = _BedrockChatAdapterImpl;
    ...
    class ChatAdapterBuilderImpl {
      constructor() {
        __publicField(this, "credentials", null);
        __publicField(this, "inferenceConfig", null);
      ...
      create() {
        ...
        return new BedrockChatAdapterImpl({
          ...
          credentials: this.credentials ?? void 0,
          region: this.region ?? void 0,
          inferenceConfig: this.inferenceConfig ?? void 0
        });
      }
      withCredintial(cred) {
